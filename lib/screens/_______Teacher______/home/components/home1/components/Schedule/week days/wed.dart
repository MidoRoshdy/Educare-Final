                                  ...
                                  child: Column(
                                    children: [
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            Text(_data[index]['wed_Subject1'] !=
                                                    widget.teachersubject
                                                ? (_data[1]['wed_Subject1'] !=
                                                        widget.teachersubject
                                  ...
                                  child: Column(
                                    children: [
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            Text(_data[index]['wed_Subject2'] !=
                                                    widget.teachersubject
                                                ? (_data[1]['wed_Subject2'] !=
                                                        widget.teachersubject
                                                    ? "you have no class today"
                                                    : _data[1]['wed_Subject2'])
                                  ...
                                  child: Column(
                                    children: [
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            Text(_data[index]['wed_Subject3'] !=
                                                    widget.teachersubject
                                                ? (_data[1]['wed_Subject3'] !=
                                                        widget.teachersubject
                                                    ? "you have no class today"
                                                    : _data[1]['wed_Subject3'])
                                  ...
                                  child: Column(
                                    children: [
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            Text(_data[index]['wed_Subject4'] !=
                                                    widget.teachersubject
                                                ? (_data[1]['wed_Subject4'] !=
                                                        widget.teachersubject
                                                    ? "you have no class today"
                                                    : _data[1]['wed_Subject4'])
                                  ...
                                  child: Column(
                                    children: [
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            Text(_data[index]['wed_Subject5'] !=
                                                    widget.teachersubject
                                                ? (_data[1]['wed_Subject5'] !=
                                                        widget.teachersubject
                                                    ? "you have no class today"
                                                    : _data[1]['wed_Subject5'])
                                  ...
                                  child: Column(
                                    children: [
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            Text(_data[index]['wed_Subject6'] !=
                                                    widget.teachersubject
                                                ? (_data[1]['wed_Subject6'] !=
                                                        widget.teachersubject
                                                    ? "you have no class today"
                                                    : _data[1]['wed_Subject6'])

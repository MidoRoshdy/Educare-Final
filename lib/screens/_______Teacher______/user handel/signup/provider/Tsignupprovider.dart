...
import 'package:educare/screens/_______Teacher______/user%20handel/signup/provider/Tsignupstate.dart';
import 'package:email_validator/email_validator.dart';
import 'package:flutter/material.dart';
import 'package:intl_phone_number_input/intl_phone_number_input.dart';

class TeacherCreateAccountProvider extends ChangeNotifier {
  // ignore: unused_field
  final TeacherCreateAccountState state = TeacherCreateAccountState();
  ...
  navigateToLogin(BuildContext context) {
    Navigator.of(context).pushReplacementNamed(AppRoutes.teacher_login);
  }

  createAccount(BuildContext context) {
    Navigator.of(context)
        .pushNamedAndRemoveUntil(AppRoutes.teacher_login, (route) => false);
  }
